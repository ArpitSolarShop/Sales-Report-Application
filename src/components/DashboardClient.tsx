...
export default function DashboardClient({ initialRecords }: { initialRecords: RecordData[] }) {
    ...
    }, [allData, searchTerm, selectedRep]);
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100 pb-20 print:bg-white print:p-0 print:pb-0">
            <main className="max-w-7xl mx-auto p-6 space-y-6 print:space-y-4 print:p-4 print:max-w-none">
                ...
                <header className="flex justify-between items-end border-b-[3px] border-slate-900 pb-6 mb-8 pt-2 print:pt-0 print:pb-4 print:mb-6">
                    ...
                    <div className="text-right">
                        <p className="text-sm print:text-xs font-black uppercase text-slate-800">Report Date: May 2026</p>
                        <p className="text-xs print:text-[10px] text-slate-500 font-medium mt-0.5">Generated: {currentDate}</p>
                        
                        <div className="flex items-center gap-2 mt-4 print:hidden justify-end">
                            {selectedRep && (
                                <button onClick={() => setSelectedRep(null)} className="flex text-xs font-bold text-blue-600 bg-blue-50 px-3 py-2 rounded-xl border border-blue-100 items-center gap-1 hover:bg-blue-100">
                            ...
                            <div className="relative hidden md:block">
                                ...
                                <input 
                                    ...
                                    className="pl-8 pr-3 py-2 bg-slate-100 border-none rounded-xl text-xs w-36 focus:ring-2 focus:ring-blue-500 transition-all outline-none" 
                                />
                            </div>
                            <button onClick={handlePrint} className="bg-slate-900 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 hover:bg-slate-800 shadow-md transition-transform active:scale-95">
                                <Printer className="w-3.5 h-3.5" /> Print PDF
                            </button>
                            <button onClick={() => setIsSyncModalOpen(true)} className="bg-blue-600 text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 hover:bg-blue-700 shadow-md transition-transform active:scale-95">
            ...
            <footer className="max-w-7xl mx-auto px-6 text-slate-400 text-[9px] font-bold uppercase tracking-[0.2em] mt-8 flex justify-between items-center print:mt-4 print:pb-4">
                <div className="flex items-center gap-4">
                    <span className="flex items-center gap-1 font-black"><MapPin className="w-3 h-3" /> Regional Center</span>
                </div>
                <div className="flex items-center gap-6">
                    <span className="bg-white px-3 py-1 rounded-full border border-slate-200">CONFIDENTIAL • MAY 2026 AUDIT CYCLE</span>
                </div>
            </footer>
