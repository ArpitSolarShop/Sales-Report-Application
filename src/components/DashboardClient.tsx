                    ...
                    <div className="text-right">
                        ...
                        <div className="flex items-center gap-2 mt-4 print:hidden justify-end">
                            ...
                            <select 
                                ...
                                className="px-3 py-2 bg-slate-100 border-none rounded-xl text-xs font-bold text-slate-700 focus:ring-2 focus:ring-blue-500 transition-all outline-none cursor-pointer appearance-none shadow-sm"
